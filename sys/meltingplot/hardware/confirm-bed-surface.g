; hardware/confirm-bed-surface.g
...
if global.debug
  echo "hardware/confirm-bed-surface.g"
...
echo >{var.file} "; build plate surface - written by hardware/confirm-bed-surface.g, do not edit"
