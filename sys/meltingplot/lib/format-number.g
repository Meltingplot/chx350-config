; lib/format-number.g - format a number with a fixed number of decimals, right aligned in a column
;
; Parameters:
...
;
; Usage: M98 P"0:/sys/meltingplot/lib/format-number.g" F{sensors.probes[0].value[0]} D3 W12
;
...
if !exists(param.F)
  echo "format-number.g: missing F parameter"
